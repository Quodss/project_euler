    ...
    product-max  %+  max
                 ...
                 %+  roll
                   ...
                   :~
                     (snag i (snag j grid))
                     (snag i (snag +(j) grid))
                     (snag i (snag (add j 2) grid))
                     (snag i (snag (add j 3) grid))
                   ==
                 mul
  ==
=.  product-max
    ...
    product-max  %+  max
                 ...
                 %+  roll
                   ...
                   :~
                     (snag i (snag j grid))
                     (snag +(i) (snag +(j) grid))
                     (snag (add i 2) (snag (add j 2) grid))
                     (snag (add i 3) (snag (add j 3) grid))
                   ==
                 mul
  ==
=.  product-max
  ...
  %=  $
    ...
    product-max  %+  max
                 ...
                 %+  roll
                   ...
                   :~
                     (snag i (snag j grid))
                     (snag +(i) (snag (dec j) grid))
                     (snag (add i 2) (snag (sub j 2) grid))
                     (snag (add i 3) (snag (sub j 3) grid))
                   ==
                 mul
  ==
product-max
